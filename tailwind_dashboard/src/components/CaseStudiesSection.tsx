  ...
  return (
    <section id="case-studies" className="py-12 px-4 bg-gray-100">
      <div className="container mx-auto">
        ...
        <p className="text-center max-w-3xl mx-auto mb-10 text-gray-600">Examining real-world examples helps illustrate the capabilities and challenges of microgrids, particularly in university and critical facility settings. These cases offer valuable lessons for resilience planning.</p>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-screen-xl mx-auto">
          {/* Case Study 1: SRJC */}
          <div className="bg-white border border-gray-300 rounded-lg p-6 shadow-sm flex flex-col transition-transform duration-200 ease-in-out hover:-translate-y-1 hover:shadow-md">
            ...
            <ul className="list-disc list-inside mb-4 text-gray-700 ml-6 pl-2">
              <li className="mb-1.5"><strong>Emergency Resilience:</strong> Stayed open during PG&E power shutdowns, serving as a safe place.</li>
              <li className="mb-1.5"><strong>Green Power:</strong> Solar panels and batteries enhance energy independence and cleanliness.</li>
            ...
            <Link href="https://sustainability.santarosa.edu/srjc-micro-grid" target="_blank" rel="noopener noreferrer" className="inline-block mt-2 mr-2 text-blue-600 hover:underline hover:text-blue-800 text-sm font-medium no-underline">Learn More (SRJC Sustainability)</Link>
          </div>
          ...
          <div className="bg-white border border-gray-300 rounded-lg p-6 shadow-sm flex flex-col">
            ...
            <ul className="list-disc list-inside mb-4 text-gray-700 ml-6 pl-2">
              <li className="mb-1.5"><strong>Zero Unplanned Outages:</strong> Remained operational during Winter Storm Uri, providing essential services.</li>
              <li className="mb-1.5"><strong>Green Energy Push:</strong> Incorporates rooftop solar and thermal storage, committed to carbon neutrality.</li>
            ...
            <Link href="https://peer.gbci.org/sites/default/files/resources/UT-Austin-Case-Study.pdf" target="_blank" rel="noopener noreferrer" className="inline-block mt-2 mr-2 text-blue-600 hover:underline hover:text-blue-800 text-sm font-medium no-underline">UT Austin Case Study (PDF)</Link>
            <Link href="https://law.utexas.edu/transnational/events/field-trip-ut-power-plant/" target="_blank" rel="noopener noreferrer" className="inline-block mt-2 text-blue-600 hover:underline hover:text-blue-800 text-sm font-medium no-underline">More on UT Power Plant</Link>
          </div>
          ...
          <div className="bg-white border border-gray-300 rounded-lg p-6 shadow-sm flex flex-col">
            ...
            <ul className="list-disc list-inside mb-4 text-gray-700 ml-6 pl-2">
              <li className="mb-1.5"><strong>Green Innovation:</strong> Used clean energy sources aligned with its conservation mission.</li>
              <li className="mb-1.5"><strong>Energy Cost Savings:</strong> Lowered utility bills and reduced grid reliance.</li>
            ...
            <ul className="list-disc list-inside mb-4 text-gray-700">
              <li className="mb-1.5"><strong>Limited Storage:</strong> Battery capacity insufficient for longer blackouts.</li>
              <li className="mb-1.5"><strong>High Maintenance:</strong> Fuel cells required frequent, skilled upkeep.</li>
            ...
            <Link href="https://www.facilitiesdive.com/news/bronx-zoos-energy-overhaul-promises-nearly-500k-in-annual-cost-savings-n/716823/" target="_blank" rel="noopener noreferrer" className="inline-block mt-2 mr-2 text-blue-600 hover:underline hover:text-blue-800 text-sm font-medium no-underline">Bronx Zoo Energy Overhaul</Link>
            <Link href="https://amny.com/sponsored/con-edison-and-bronx-zoos-waste-heat-project/" target="_blank" rel="noopener noreferrer" className="inline-block mt-2 text-blue-600 hover:underline hover:text-blue-800 text-sm font-medium no-underline">Waste Heat Project Info</Link>
          </div>
        </div>
      </div>
    </section>
