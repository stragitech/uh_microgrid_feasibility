    ...
    const loadData = async () => {
      try {
        ...
        const cleanedData = (jsonData as RawExcelRow[]).map(row => ({
          ...
          'CHP Capacity (kW)': parseFloat(String(row['CHP Capacity (kW)'] || '0')) || 0,
          'Solar Capacity (kW)': parseFloat(String(row['Solar Capacity (kW)'] || '0')) || 0,
          'Wind Capacity (kW)': parseFloat(String(row['Wind Capacity (kW)'] || '0')) || 0,
          'Hydro Capacity (kW)': parseFloat(String(row['Hydro Capacity (kW)'] || '0')) || 0,
          'Fuel Cell Capacity (kW)': parseFloat(String(row['Fuel Cell Capacity (kW)'] || '0')) || 0,
          'Diesel Capacity (kW)': parseFloat(String(row['Diesel Capacity (kW)'] || '0')) || 0,
          'Natural Gas Capacity (kW)': parseFloat(String(row['Natural Gas Capacity (kW)'] || '0')) || 0,
          'Biogas Capacity (kW)': parseFloat(String(row['Biogas Capacity (kW)'] || '0')) || 0,
